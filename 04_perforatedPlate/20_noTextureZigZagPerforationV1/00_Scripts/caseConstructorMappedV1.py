...
dA      = 2.0*0.30e-3                                                   #width of 1 cell
dL      = 2.0*0.30e-3                                                   #length of 1 cell
dH      = 2.0*0.05e-3                                                   #height of 1 cell
...
if CHILD:
    ...
    caseDir     = ('../iF_Re' + 
                ...
                '_' + liqName + '_PSV2_MAPPED/'
                )
else:
    baseCase  ='../01_baseCaseInit/'
    caseDir     = ('../iF_Re' + 
                repr(round(Re,4)) + '_' + repr(round(alpha*180/math.pi)) + 
                '_' + liqName + '_PSV2_INIT/'
                )
