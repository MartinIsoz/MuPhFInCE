...
from fblockMeshGenV10 import fblockMeshGen                                 #blockMeshDict generation
...
dA      = 2.0*0.25e-3                                                   #width of 1 cell
dL      = 2.0*0.25e-3                                                   #length of 1 cell
dH      = 2.0*0.07e-3                                                   #height of 1 cell
...
nOuterCorrectors    = 100                                               #maximal number of PIMPLE iterations
nCorrectors         = 2                                                 #number of correctors in PISO loop
nNonOrthoCorrectors = 15                                                 #number of non-orthogonal correctors in each PIMPLE iteration
...
wrInt       = 0.005                                                      #simulation write interval
...
# inlet as a initial condition
#
README.write('\n setFieldsDict\n')

idStr = ['box (0 0 0) (1 1 ', 'volVectorFieldValue U ' ]
